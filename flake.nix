...
{
  description = "Nix flake for pythoneda-runtime/boot";
  inputs = rec {
    ...
    pythoneda-shared-runtime-lifecycle-events = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-shared-runtime-def/lifecycle-events/0.0.50";
    };
  };
  outputs = inputs:
    with inputs;
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "boot";
        version = "0.0.3";
        sha256 = "157v6cfqpri8fiw1zgrwbyaxh6s4xi37pjjhsb2w6b6f5rhff9gf";
        pname = "${org}-${repo}";
        ...
        pythoneda-runtime-boot-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-shared-pythonlang-domain} ${pythoneda-shared-runtime-lifecycle-events}; do
      ...
      in rec {
        ...
        devShells = rec {
          ...
          pythoneda-runtime-boot-python312 =
            shared.devShell-for {
              ...
              extra-namespaces = "";
              nixpkgs-release = nixpkgsRelease;
              package = packages.pythoneda-runtime-boot-python312;
          ...
          pythoneda-runtime-boot-python313 =
            shared.devShell-for {
              ...
              extra-namespaces = "";
              nixpkgs-release = nixpkgsRelease;
              package = packages.pythoneda-runtime-boot-python313;
        ...
        packages = rec {
          ...
          pythoneda-runtime-boot-python312 = pythoneda-runtime-boot-for {
            python = pkgs.python312;
            pythoneda-shared-pythonlang-domain =
              pythoneda-shared-pythonlang-domain.packages.${system}.pythoneda-shared-pythonlang-domain-python312;
            pythoneda-shared-runtime-lifecycle-events =
              pythoneda-shared-runtime-lifecycle-events.packages.${system}.pythoneda-shared-runtime-lifecycle-events-python312;
          };
          pythoneda-runtime-boot-python313 = pythoneda-runtime-boot-for {
            python = pkgs.python313;
            pythoneda-shared-pythonlang-domain =
              pythoneda-shared-pythonlang-domain.packages.${system}.pythoneda-shared-pythonlang-domain-python313;
            pythoneda-shared-runtime-lifecycle-events =
              pythoneda-shared-runtime-lifecycle-events.packages.${system}.pythoneda-shared-runtime-lifecycle-events-python313;
          };
        };
      });
}
